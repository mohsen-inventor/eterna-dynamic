    ...
    <section className={styles.solutions} id="solutions">
      <div className="container">
        ...
        <div className={styles.solutions__content}>
          {/* Problems Column */}
          <div className={`${styles.solutions__column} ${styles.solutions__problems}`}>
            {problems.map((problem, idx) => (
              <div key={idx} className={styles.solutions__card}>
          ...
          <div className={styles.solutions__center}>
            <div className={styles.solutions__cosmos}>
          ...
          {/* Solutions Column */}
          <div className={`${styles.solutions__column} ${styles.solutions__solutions}`}>
